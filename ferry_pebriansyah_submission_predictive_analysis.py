# -*- coding: utf-8 -*-
"""Ferry Pebriansyah_submission_predictive_analysis.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1YKYrO1Tfkp9OytzTygaWaEwZxumRfHDi
...
|------------------------------|------------|------------------------------------------------------------|
| Chest Pain                   | Binary     | Adanya rasa nyeri dada (1 = ya, 0 = tidak)                 |
| Shortness of Breath          | Binary     | Mengalami sesak napas (1 = ya, 0 = tidak)                  |
| Irregular Heartbeat          | Binary     | Irama jantung tidak teratur (1 = ya, 0 = tidak)            |
| Fatigue & Weakness           | Binary     | Merasa lelah dan lemah (1 = ya, 0 = tidak)                 |
| Dizziness                   | Binary     | Merasa pusing atau kepala berputar (1 = ya, 0 = tidak)     |
| Swelling (Edema)            | Binary     | Pembengkakan pada tubuh (1 = ya, 0 = tidak)                 |
| Pain in Neck/Jaw/Shoulder/Back | Binary  | Nyeri pada leher, rahang, bahu, atau punggung (1 = ya, 0 = tidak) |
| Excessive Sweating          | Binary     | Berkeringat berlebihan (1 = ya, 0 = tidak)                  |
| Persistent Cough            | Binary     | Batuk terus menerus (1 = ya, 0 = tidak)                     |
| Nausea/Vomiting             | Binary     | Mual atau muntah (1 = ya, 0 = tidak)                        |
| High Blood Pressure         | Binary     | Tekanan darah tinggi (1 = ya, 0 = tidak)                    |
| Chest Discomfort (Activity) | Binary     | Ketidaknyamanan dada saat aktivitas (1 = ya, 0 = tidak)    |
| Cold Hands/Feet             | Binary     | Tangan atau kaki terasa dingin (1 = ya, 0 = tidak)          |
| Snoring/Sleep Apnea         | Binary     | Mendengkur atau apnea tidur (1 = ya, 0 = tidak)             |
| Anxiety/Feeling of Doom     | Binary     | Merasa cemas atau takut (1 = ya, 0 = tidak)                 |
| At Risk                     | Binary     | Status risiko stroke (1 = berisiko, 0 = tidak)              |
...
### Hubungan Gejala dengan Risiko Stroke (Multivariate Countplot)
"""
...
"""**insighr**: Usia dan tekanan darah tinggi merupakan faktor risiko yang cukup kuat terhadap stroke. Gejala seperti sesak napas, kelelahan, detak jantung tidak teratur, dan nyeri dada juga ikut berkontribusi, meskipun dalam tingkat korelasi yang lebih lemah.
...
- True Negatives (TN): 4,732 — model dengan benar mengenali orang yang tidak berisiko stroke.

- True Positives (TP): 8,899 — model dengan benar mengenali orang yang berisiko stroke.

- False Negatives (FN): 58 — orang yang seharusnya berisiko stroke tapi model tidak mengenalinya → ini paling krusial karena bisa fatal.

- False Positives (FP): 107 — orang yang tidak berisiko stroke tapi dikira berisiko → lebih dapat diterima dibanding FN
...
def infer_stroke_risk(model, label_encoder):
    ...
    print("\n🧠 Prediksi risiko stroke Anda adalah:", pred_label[0])
